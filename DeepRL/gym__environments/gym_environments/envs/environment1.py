...
class Env1(gym.Env):
  ...
  """
    def __init__(self):
        ...
        self.observation_space = spaces.Box(low=0.0, high=1.0, shape=( 2,2))  # Assuming both capacity and betweenness are normalized
    ...
    def reset(self):
        ...
        # self.observation_space = [EdgeObservation(c, b) for c, b in zip(self.graph_state[:, 0], self.between_feature)]
...
#   def __init__(self, capacity, normalized_betweenness):
#     self.capacity = capacity
#     self.normalized_betweenness = normalized_betweenness